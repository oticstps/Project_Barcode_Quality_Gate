...
def main():
    ...
    print("GPIO 21 aktif berkedip untuk:", QR_149)
    print("GPIO 20 aktif berkedip untuk:", QR_88)
    ...
    while True:
        ...
        # Scan 1 tidak terdaftar
        if scan_1 not in QR_VALID:
            print("Scan urutan 1 tidak sesuai / tidak terdaftar.")
            print("Scan diabaikan. Silakan scan urutan 1 yang valid.")
            print("Tidak ada suara untuk scan 1 invalid.")
            print("-------------------------------------")
            continue

        print("Scan urutan 1 diterima:", scan_1)

        relay_pin = QR_TO_GPIO[scan_1]
        ...
        # PENGECEKAN HASIL
        # =========================
        if scan_1 == scan_2 and scan_1 in QR_VALID:
            system_locked = False
            print("HASIL: OK")
